...
В данном проекте реализован один из вариантов табличного вывода данных. В таблице возможна сортировка в алфавитном порядке (от А-Я и обратно), поиск и постраничный вывод данных (пагинация).

## Технологии, используемые в проекте

Проект создан при помощи React версии [18](https://reactjs.org/blog/2022/03/29/react-v18.html), библиотека компонентов [MUI](https://mui.com/) для тестирования использовался фреймворк [jest](https://jestjs.io/ru/).
